...
object SimpleQueueTest{
  ...
  def main(args: Array[String]) = {
    ...
    while(r < reps && result > 0){
      ...
      val seqQueue = Queue[Int]() //      val concQueue : ConcQueue = queueType match{
...
//      }
//      val concQueue = new LinkedArrayList[Int]
      val concQueue = new ox.cads.collection.LockFreeQueue[Int]
